...
namespace EligereES.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        {       
            ...
            await saml2AuthnResponse.CreateSession(HttpContext, claimsTransform: (claimsPrincipal) => ClaimsTransform.Transform(_conf, claimsPrincipal));
        ...
        {
            // FixMe: this traps an unwanted exception due to a problem on logout
            try
            {
                var binding = new Saml2PostBinding();
